import * as MAIN from './diyRoom.js';
...
import { addNewThingToFirebase } from './firebaseSetup.js';
...
export function initHTML() {
    ...
    textInput.addEventListener("keydown", function (e) {
        if (e.key === "Enter") {  //checks whether the pressed key is "Enter"
            ...
            const user = MAIN.auth.currentUser;
            if (!user) {
            ...
            if (isEditing) {
                ...
                FB.updateJSONFieldInFirebase('texts', editingObject.key, data);
                isEditing = false;
            } else {
