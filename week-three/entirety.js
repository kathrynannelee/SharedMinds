//Notice import map in html //import * as THREE from 'https://cdnjs.cloudflare.com/ajax/libs/three.js/0.160.1/three.module.min.js';
...
function div3DDoubleClick(event) {
    ...
    const pos = find3DCoornatesInFrontOfCamera(150 - camera.fov, mouse);
    creatNewModel('./building.glb', pos);
